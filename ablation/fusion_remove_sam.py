...
from DR_train_remove_sam import DDKGModel
...
class Args:
    def __init__(self):
        ...
        self.dr_checkpoint = '/data/pengxiao/Osteosarcoma_diagnosis/ablation/checkpoints/gating_with2loss_no_sam/no_sam_swin_model/best_no_sam_model_epoch97_acc0.776_auc0.846.pth'
