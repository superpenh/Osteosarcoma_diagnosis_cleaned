...
parser.add_argument('--checkpoint_path', type=str, default='segmentor', help='where checkpoint saved')
...
parser.add_argument('--load_from_checkpoint', type=str, default='../checkpoints/segmentation/segmentor/checkpoint_5.h5', help='where checkpoint loaded')
parser.add_argument('--optim', type=str, default='sgd', help='which optimizer')
parser.add_argument('--lr_decay_epoch', type=int, default=5, help='how many epoch to decay learning rate')
parser.add_argument('--eval', action='store_true', help='doing evaluation only')

parser.add_argument('--wsi_dir',              type=str, default='/home/pengxiao/disk/病理/OS.tif/OS_2.TIF/test')
parser.add_argument('--res_dir',              type=str, default='/data/pengxiao/Osteosarcoma_diagnosis/data/FAH_only_patch')
...
parser.add_argument('--num_grids',             type=int, default=200)
...
opt.data_path='/data/pengxiao/Osteosarcoma_diagnosis/data/segmentation/'

# training model directory
checkpoint_root = '/data/pengxiao/Osteosarcoma_diagnosis/checkpoints/segmentation/'
